...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/ext/', 'php');
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'reff_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_config_text');
    }
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['migrator']) ? $this->services['migrator'] : $this->getMigratorService()) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.delete'] = new \phpbb\console\command\thumbnail\delete(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.generate'] = new \phpbb\console\command\thumbnail\generate(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.add'] = new \phpbb\console\command\user\add(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['passwords.manager']) ? $this->services['passwords.manager'] : $this->getPasswords_ManagerService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'reff_forums', 'reff_posts', 'reff_topics', 'reff_users');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'});
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('reff_captcha_questions', 'reff_captcha_answers', 'reff_qa_confirm');
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this, ${($_ = isset($this->services['routing.helper']) ? $this->services['routing.helper'] : $this->getRouting_HelperService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/cache/production/');
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    ...
    {
        return new \phpbb\db\extractor\mysql_extractor('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\oracle_extractor('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\postgres_extractor('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\db\extractor\sqlite3_extractor('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn.driver']) ? $this->services['dbal.conn.driver'] : $this->get('dbal.conn.driver', 1)) && false ?: '_'});
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'reff_ext', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['feed.quote_helper'] = new \phpbb\feed\quote_helper(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator(${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/');
    }
    ...
    {
        return new \phpbb\files\types\remote(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['files.factory']) ? $this->services['files.factory'] : ($this->services['files.factory'] = new \phpbb\files\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['php_ini']) ? $this->services['php_ini'] : ($this->services['php_ini'] = new \bantu\IniGetWrapper\IniGetWrapper())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'});
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/');
    }
    ...
    {
        $this->services['language.loader'] = $instance = new \phpbb\language\language_file_loader('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    ...
    {
        return $this->services['log'] = new \phpbb\log\log(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'adm/', 'php', 'reff_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['module.manager']) ? $this->services['module.manager'] : $this->getModule_ManagerService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'reff_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, 'reff_modules', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'reff_notification_emails');
    }
    ...
    {
        return new \phpbb\notification\method\jabber(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'reff_user_notifications');
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper(${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['phpbb.ucp.controller.reset_password'] = new \phpbb\ucp\controller\reset_password(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['passwords.manager']) ? $this->services['passwords.manager'] : $this->getPasswords_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, 'reff_users', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['phpbb.viglink.acp_listener'] = new \phpbb\viglink\event\acp_listener(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['phpbb.viglink.helper']) ? $this->services['phpbb.viglink.helper'] : $this->getPhpbb_Viglink_HelperService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['php_ini']) ? $this->services['php_ini'] : ($this->services['php_ini'] = new \bantu\IniGetWrapper\IniGetWrapper())) && false ?: '_'}, ${($_ = isset($this->services['mimetype.guesser']) ? $this->services['mimetype.guesser'] : $this->getMimetype_GuesserService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_profile_fields_lang');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->getRouterService()) && false ?: '_'}, ${($_ = isset($this->services['symfony_request']) ? $this->services['symfony_request'] : $this->getSymfonyRequestService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\default_resources_locator('/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'production', ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'});
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_bbcodes', 'reff_smilies', 'reff_styles', 'reff_words', '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/styles/');
    }
    ...
    {
        return $this->services['text_formatter.s9e.quote_helper'] = new \phpbb\textformatter\s9e\quote_helper(${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php');
    }
    ...
    {
        $this->services['text_formatter.s9e.renderer'] = $instance = new \phpbb\textformatter\s9e\renderer(${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/cache/production/', '_text_formatter_renderer', ${($_ = isset($this->services['text_formatter.s9e.factory']) ? $this->services['text_formatter.s9e.factory'] : $this->getTextFormatter_S9e_FactoryService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'});
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'reff_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/', 'php', 'reff_users');
    }
    ...
    {
        return [
            'core.root_path' => '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/',
            'core.php_ext' => 'php',
            'core.environment' => 'production',
            'core.debug' => false,
            'core.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/cache/production/',
            ...
            'text_formatter.cache.dir' => '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/cache/production/',
            'text_formatter.cache.parser.key' => '_text_formatter_parser',
            'text_formatter.cache.renderer.key' => '_text_formatter_renderer',
            'core.template.cache_path' => '/Applications/XAMPP/xamppfiles/htdocs/RefittingMachinesForum/cache/production/twig/',
            'tables.acl_groups' => 'reff_acl_groups',
            'tables.acl_options' => 'reff_acl_options',
            'tables.acl_roles' => 'reff_acl_roles',
            'tables.acl_roles_data' => 'reff_acl_roles_data',
            'tables.acl_users' => 'reff_acl_users',
            'tables.attachments' => 'reff_attachments',
            'tables.auth_provider_oauth_token_storage' => 'reff_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'reff_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'reff_oauth_accounts',
            'tables.banlist' => 'reff_banlist',
            'tables.bbcodes' => 'reff_bbcodes',
            'tables.bookmarks' => 'reff_bookmarks',
            'tables.bots' => 'reff_bots',
            'tables.captcha_qa_questions' => 'reff_captcha_questions',
            'tables.captcha_qa_answers' => 'reff_captcha_answers',
            'tables.captcha_qa_confirm' => 'reff_qa_confirm',
            'tables.config' => 'reff_config',
            'tables.config_text' => 'reff_config_text',
            'tables.confirm' => 'reff_confirm',
            'tables.disallow' => 'reff_disallow',
            'tables.drafts' => 'reff_drafts',
            'tables.ext' => 'reff_ext',
            'tables.extensions' => 'reff_extensions',
            'tables.extension_groups' => 'reff_extension_groups',
            'tables.forums' => 'reff_forums',
            'tables.forums_access' => 'reff_forums_access',
            'tables.forums_track' => 'reff_forums_track',
            'tables.forums_watch' => 'reff_forums_watch',
            'tables.groups' => 'reff_groups',
            'tables.icons' => 'reff_icons',
            'tables.lang' => 'reff_lang',
            'tables.log' => 'reff_log',
            'tables.login_attempts' => 'reff_login_attempts',
            'tables.migrations' => 'reff_migrations',
            'tables.moderator_cache' => 'reff_moderator_cache',
            'tables.modules' => 'reff_modules',
            'tables.notification_emails' => 'reff_notification_emails',
            'tables.notification_types' => 'reff_notification_types',
            'tables.notifications' => 'reff_notifications',
            'tables.poll_options' => 'reff_poll_options',
            'tables.poll_votes' => 'reff_poll_votes',
            'tables.posts' => 'reff_posts',
            'tables.privmsgs' => 'reff_privmsgs',
            'tables.privmsgs_folder' => 'reff_privmsgs_folder',
            'tables.privmsgs_rules' => 'reff_privmsgs_rules',
            'tables.privmsgs_to' => 'reff_privmsgs_to',
            'tables.profile_fields' => 'reff_profile_fields',
            'tables.profile_fields_data' => 'reff_profile_fields_data',
            'tables.profile_fields_options_language' => 'reff_profile_fields_lang',
            'tables.profile_fields_language' => 'reff_profile_lang',
            'tables.ranks' => 'reff_ranks',
            'tables.reports' => 'reff_reports',
            'tables.reports_reasons' => 'reff_reports_reasons',
            'tables.search_results' => 'reff_search_results',
            'tables.search_wordlist' => 'reff_search_wordlist',
            'tables.search_wordmatch' => 'reff_search_wordmatch',
            'tables.sessions' => 'reff_sessions',
            'tables.sessions_keys' => 'reff_sessions_keys',
            'tables.sitelist' => 'reff_sitelist',
            'tables.smilies' => 'reff_smilies',
            'tables.sphinx' => 'reff_sphinx',
            'tables.styles' => 'reff_styles',
            'tables.styles_template' => 'reff_styles_template',
            'tables.styles_template_data' => 'reff_styles_template_data',
            'tables.styles_theme' => 'reff_styles_theme',
            'tables.styles_imageset' => 'reff_styles_imageset',
            'tables.styles_imageset_data' => 'reff_styles_imageset_data',
            'tables.teampage' => 'reff_teampage',
            'tables.topics' => 'reff_topics',
            'tables.topics_posted' => 'reff_topics_posted',
            'tables.topics_track' => 'reff_topics_track',
            'tables.topics_watch' => 'reff_topics_watch',
            'tables.user_group' => 'reff_user_group',
            'tables.user_notifications' => 'reff_user_notifications',
            'tables.users' => 'reff_users',
            'tables.warnings' => 'reff_warnings',
            'tables.words' => 'reff_words',
            'tables.zebra' => 'reff_zebra',
            ...
            'tables' => [
                'acl_groups' => 'reff_acl_groups',
                'acl_options' => 'reff_acl_options',
                'acl_roles' => 'reff_acl_roles',
                'acl_roles_data' => 'reff_acl_roles_data',
                'acl_users' => 'reff_acl_users',
                'attachments' => 'reff_attachments',
                'auth_provider_oauth_token_storage' => 'reff_oauth_tokens',
                'auth_provider_oauth_states' => 'reff_oauth_states',
                'auth_provider_oauth_account_assoc' => 'reff_oauth_accounts',
                'banlist' => 'reff_banlist',
                'bbcodes' => 'reff_bbcodes',
                'bookmarks' => 'reff_bookmarks',
                'bots' => 'reff_bots',
                'captcha_qa_questions' => 'reff_captcha_questions',
                'captcha_qa_answers' => 'reff_captcha_answers',
                'captcha_qa_confirm' => 'reff_qa_confirm',
                'config' => 'reff_config',
                'config_text' => 'reff_config_text',
                'confirm' => 'reff_confirm',
                'disallow' => 'reff_disallow',
                'drafts' => 'reff_drafts',
                'ext' => 'reff_ext',
                'extensions' => 'reff_extensions',
                'extension_groups' => 'reff_extension_groups',
                'forums' => 'reff_forums',
                'forums_access' => 'reff_forums_access',
                'forums_track' => 'reff_forums_track',
                'forums_watch' => 'reff_forums_watch',
                'groups' => 'reff_groups',
                'icons' => 'reff_icons',
                'lang' => 'reff_lang',
                'log' => 'reff_log',
                'login_attempts' => 'reff_login_attempts',
                'migrations' => 'reff_migrations',
                'moderator_cache' => 'reff_moderator_cache',
                'modules' => 'reff_modules',
                'notification_emails' => 'reff_notification_emails',
                'notification_types' => 'reff_notification_types',
                'notifications' => 'reff_notifications',
                'poll_options' => 'reff_poll_options',
                'poll_votes' => 'reff_poll_votes',
                'posts' => 'reff_posts',
                'privmsgs' => 'reff_privmsgs',
                'privmsgs_folder' => 'reff_privmsgs_folder',
                'privmsgs_rules' => 'reff_privmsgs_rules',
                'privmsgs_to' => 'reff_privmsgs_to',
                'profile_fields' => 'reff_profile_fields',
                'profile_fields_data' => 'reff_profile_fields_data',
                'profile_fields_options_language' => 'reff_profile_fields_lang',
                'profile_fields_language' => 'reff_profile_lang',
                'ranks' => 'reff_ranks',
                'reports' => 'reff_reports',
                'reports_reasons' => 'reff_reports_reasons',
                'search_results' => 'reff_search_results',
                'search_wordlist' => 'reff_search_wordlist',
                'search_wordmatch' => 'reff_search_wordmatch',
                'sessions' => 'reff_sessions',
                'sessions_keys' => 'reff_sessions_keys',
                'sitelist' => 'reff_sitelist',
                'smilies' => 'reff_smilies',
                'sphinx' => 'reff_sphinx',
                'styles' => 'reff_styles',
                'styles_template' => 'reff_styles_template',
                'styles_template_data' => 'reff_styles_template_data',
                'styles_theme' => 'reff_styles_theme',
                'styles_imageset' => 'reff_styles_imageset',
                'styles_imageset_data' => 'reff_styles_imageset_data',
                'teampage' => 'reff_teampage',
                'topics' => 'reff_topics',
                'topics_posted' => 'reff_topics_posted',
                'topics_track' => 'reff_topics_track',
                'topics_watch' => 'reff_topics_watch',
                'user_group' => 'reff_user_group',
                'user_notifications' => 'reff_user_notifications',
                'users' => 'reff_users',
                'warnings' => 'reff_warnings',
                'words' => 'reff_words',
                'zebra' => 'reff_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'reff_',
